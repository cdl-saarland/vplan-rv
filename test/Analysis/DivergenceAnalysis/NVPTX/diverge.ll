; RUN: opt %s -analyze -divergence -use-rv-da | FileCheck %s
...
; CHECK-LABEL: Printing analysis 'Kernel Divergence Analysis' for function 'no_diverge'
entry:
...
; CHECK-LABEL: Printing analysis 'Kernel Divergence Analysis' for function 'sync'
bb1:
...
; CHECK-LABEL: Printing analysis 'Kernel Divergence Analysis' for function 'mixed'
bb1:
...
; CHECK-LABEL: Printing analysis 'Kernel Divergence Analysis' for function 'device'
...
define i32 @loop() {
; CHECK-LABEL: Printing analysis 'Kernel Divergence Analysis' for function 'loop'
entry:
...
define i32 @lcssa() {
; CHECK-LABEL: Printing analysis 'Kernel Divergence Analysis' for function 'lcssa'
entry:
  %tid = call i32 @llvm.nvvm.read.ptx.sreg.tid.x()
  br label %loop
loop:
...
; CHECK-LABEL: Printing analysis 'Kernel Divergence Analysis' for function 'unstructured_loop'
entry:
  %tid = call i32 @llvm.nvvm.read.ptx.sreg.tid.x()
